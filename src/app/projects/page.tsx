...
const DESCRIPTION =
  'Проекты Дмитрия Пятакова: OneOnOne — AI-платформа для управления командами, Mevratek — платформа для роботизированных систем, ТехФабрика — онлайн-школа программирования.';
