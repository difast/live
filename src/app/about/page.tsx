...
const DESCRIPTION =
  'Дмитрий Пятаков — предприниматель. Создаёт технологические компании и продукты: OneOnOne, Mevratek, ТехФабрика. Технологии, AI, управление и образование.';
      ...
      <section className="section" aria-labelledby="bio-heading">
        <div className={`container ${hasPortrait ? styles.intro : ''}`}>
          <div>
            ...
            >
              <p>
                В портфеле три действующих проекта. OneOnOne — AI-платформа для
